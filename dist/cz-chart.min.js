...
const barHeight = zeroY - currentY; 
...
this._renderedBars.push({
index: i,
x: value >= 0 ? drawX : drawX + drawW, 
y: drawY,
width: Math.abs(drawW), 
height: drawH,
value: value,
drawX: drawX,
drawW: drawW
...
const maxVal = Math.max(...this.dataset.values, 1); 
...
const cx = plotArea.left + plotArea.width / 2;
const cy = plotArea.top + plotArea.height * 0.85; 
...
const outerR = innerR - (maxRadius * 0.05); 
...
const thresholds = chart.options.thresholds; 
...
const watermark = chart.options.watermark; 
